package club.ampthedev.mcgradle.base.tasks.impl.decomp.new

/**
 * We have to do a lot of hacky stuff to support both 1.7-1.11 and 1.12+, including using multiple
 * different Fernflower versions. These are the fernflower implementation classes for 1.12+.
 */
...
class NewDecompiler(tempDir: File, logFile: PrintStream) : Decompiler {
