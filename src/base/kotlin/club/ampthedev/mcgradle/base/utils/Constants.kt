...
const val VANILLA_DIRECTORY = "$VERSIONS_DIRECTORY/$MC_VERSION"
const val VERSION_DIRECTORY = "$VERSIONS_DIRECTORY/$MC_VERSION-${MAPPING_CHANNEL}_$MAPPING_VERSION"
const val CLIENT_JAR = "$VANILLA_DIRECTORY/client.jar"
const val SERVER_JAR = "$VANILLA_DIRECTORY/server.jar"
const val SPLIT_SERVER_JAR = "$VANILLA_DIRECTORY/split_server.jar"
const val MERGED_JAR = "$VANILLA_DIRECTORY/merged.jar"
const val MAPPINGS_DIRECTORY = "$VERSION_DIRECTORY/mappings"
const val JOINED_SRG = "$MAPPINGS_DIRECTORY/joined.srg"
const val JOINED_TSRG = "$MAPPINGS_DIRECTORY/config/joined.tsrg"
...
const val PARAMS_CSV = "$MAPPINGS_DIRECTORY/params.csv"
...
const val PATCHED_JAR = "$VERSION_DIRECTORY/patched.jar"
const val MCP_PATCHES = "$MAPPINGS_DIRECTORY/patches/minecraft_merged_ff"
const val MCP_PATCHES_NEW = "$MAPPINGS_DIRECTORY/patches/joined"
const val EXCEPTIONS_TXT = "$MAPPINGS_DIRECTORY/config/exceptions.txt"
