...
import club.ampthedev.mcgradle.tasks.mc.TaskApplyPatches;
import club.ampthedev.mcgradle.tasks.mc.TaskDecomp;
import club.ampthedev.mcgradle.tasks.mc.TaskDeobf;
import club.ampthedev.mcgradle.tasks.mc.TaskDownloadAssets;
import club.ampthedev.mcgradle.tasks.mc.TaskDownloadClient;
import club.ampthedev.mcgradle.tasks.mc.TaskDownloadNatives;
import club.ampthedev.mcgradle.tasks.mc.TaskDownloadServer;
import club.ampthedev.mcgradle.tasks.mc.TaskExtractSources;
import club.ampthedev.mcgradle.tasks.mc.TaskGenerateMappings;
import club.ampthedev.mcgradle.tasks.mc.TaskMerge;
import club.ampthedev.mcgradle.tasks.mc.TaskRecompileClean;
import club.ampthedev.mcgradle.tasks.mc.TaskResolveDependencies;
import club.ampthedev.mcgradle.tasks.mc.TaskSourceDeobf;
import club.ampthedev.mcgradle.tasks.mc.TaskSplitServerAndDeps;
import club.ampthedev.mcgradle.tasks.properties.TaskGenerateProperties;
import club.ampthedev.mcgradle.user.tasks.TaskApplyBinPatches;
